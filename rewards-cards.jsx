...
const CARDS = [
  ...
  },
  {
    ...
    af: "$795",
    welcome: "150,000 pts",
    desc: "Premium travel card, freshly refreshed in 2025. The same referral covers the Sapphire Preferred — pick the Reserve for the lounge access, Points Boost redemptions, and the bigger welcome offer.",
    benefits: [
  ...
  },
  {
    ...
    af: "$95",
    welcome: "75,000 pts",
    desc: "The same referral as Reserve, applied to the Preferred. Lower fee, slightly slimmer earn rates, but the 75k welcome offer + transfer partners still make it the best mid-tier travel card.",
    benefits: [
      "5x on Chase Travel; 3x dining/streaming/online groceries",
      "25% redemption bonus through Chase Travel portal",
      "1:1 transfers to Hyatt, United, Southwest, Air Canada",
      "$50 annual hotel credit + primary CDW on rentals",
    ],
    href: "https://www.referyourchasecard.com/19w/EFBD3HA3XO",
  },
  {
