...
const CARDS = [
  {
    ...
    desc: "The flagship Amex — built for people who actually use the lounge access and the credit stack. The refresh pushed the fee to $895 and rebuilt the credits around hotels, Resy, and lululemon. Offers are personalized: you see yours after applying, as high as 175k MR points for $12k of spend.",
    benefits: [
      "Centurion Lounge + Priority Pass + Delta Sky Club access",
      "5x on flights booked direct or via Amex Travel",
      "$600 hotel + $400 Resy + $300 lululemon + $200 airline credits",
  ...
  },
  {
    ...
    af: "$795",
    welcome: "100,000 pts",
    desc: "Premium travel card, freshly refreshed in 2025. The Points Boost redemptions and Priority Pass / Sapphire Lounge access are the real value; the credit stack covers most of the AF for anyone who actually travels — though most of it is now earmarked spending rather than the old blanket travel credit.",
    benefits: [
      "8x on Chase Travel; 4x flights/hotels direct; 3x dining",
      "$300 travel + $500 The Edit + $300 dining + $300 StubHub credits",
